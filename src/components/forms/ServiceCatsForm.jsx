...
export default function ServiceCatsForm(props) {
    ...
    React.useEffect(() => {
        if (props.updateId !== false) {
            ...
            DataService.getById("service_cats", props.updateId)
                .then((docSnap) => {
                    if (docSnap.exists()) {
        ...
        if (error.length === 0) {
            try {
                if (props.updateId === false) {
                    ...
                    DataService.updateOrCreate("service_cats", props.updateId, {
                        image_ref: values.image_ref,
                    }).then((res) => {
                        props.closeDialog();
                        props.update();
